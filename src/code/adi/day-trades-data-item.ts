...
import {
    ...
    QueryTradesDataDefinition, TradeFlagId
...
export class DayTradesDataItem extends DataItem {
    ...
    protected override start() {
        if (this._date === undefined) {
            ...
            latestDefinition.code = this._code;
            latestDefinition.marketZenithCode = this._marketZenithCode;
            ...
            datedDefinition.code = this._code;
            datedDefinition.marketZenithCode = this._marketZenithCode;
