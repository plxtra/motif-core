...
import {
    ...
    DataIvemIdAddToWatchmakerListDataDefinition,
    DataMessage,
...
export class AddToWatchlistMessageConvert extends MessageConvert {
    createRequestMessage(request: AdiPublisherRequest): Result<ZenithProtocol.MessageContainer, RequestErrorDataMessages> {
        const definition = request.subscription.dataDefinition;
        if (definition instanceof DataIvemIdAddToWatchmakerListDataDefinition) {
    ...
    private createPublishMessage(definition: DataIvemIdAddToWatchmakerListDataDefinition): Result<ZenithProtocol.MessageContainer, RequestErrorDataMessages> {
