import { AssertInternalError, Err, ErrorCode, newUndefinableDecimal, Ok, Result, ZenithDataError } from '../../../../sys/internal-api';
import {
    AdiPublisherRequest,
        ...
        if (detailsResult.isErr()) {
            ...
            const result: ZenithProtocol.TradingController.PlaceOrder.PublishMessageContainer = {
                ...
                Data: {
                    ...
                    Flags: flags,
                    Route: ZenithConvert.OrderRoute.from(definition.route),
