...
export namespace WatchlistsMessageConvert {
    ...
    function createPublishMessage(definition: QueryWatchmakerListDescriptorsDataDefinition): Result<ZenithProtocol.MessageContainer, RequestErrorDataMessages> {
    ...
    function createSubUnsubMessage(requestTypeId: AdiPublisherRequest.TypeId): Ok<ZenithProtocol.MessageContainer, RequestErrorDataMessages> {
