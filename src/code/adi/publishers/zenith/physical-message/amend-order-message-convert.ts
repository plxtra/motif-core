import { AssertInternalError, Err, newUndefinableDecimal, Ok, Result } from '@xilytix/sysutils';
        ...
        if (detailsResult.isErr()) {
            ...
            const result: ZenithProtocol.TradingController.AmendOrder.PublishMessageContainer = {
                ...
                Data: {
                    ...
                    Route: definition.route === undefined ? undefined : ZenithConvert.OrderRoute.from(definition.route),
