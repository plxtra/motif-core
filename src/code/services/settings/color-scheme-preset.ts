...
export namespace ColorSchemePreset {
    ...
    namespace Pastel {
        ...
        const itemsObject: ItemsObject = {
            ...
            Environment_Test: { id: ColorScheme.ItemId.Environment_Test, bkgd: 'yellow', fore: inherit },
            Environment_NotStandard: { id: ColorScheme.ItemId.Environment_NotStandard, bkgd: 'yellow', fore: inherit },
            ...
            Environment_Test_Offline: { id: ColorScheme.ItemId.Environment_Test_Offline, bkgd: 'orange', fore: inherit },
            Environment_NotStandard_Offline: { id: ColorScheme.ItemId.Environment_NotStandard_Offline, bkgd: 'orange', fore: inherit },
    ...
    namespace Dark {
        ...
        const itemsObject: ItemsObject = {
            ...
            Environment_Test: { id: ColorScheme.ItemId.Environment_Test, bkgd: 'yellow', fore: '#616e67' },
            Environment_NotStandard: { id: ColorScheme.ItemId.Environment_NotStandard, bkgd: 'yellow', fore: '#616e67' },
