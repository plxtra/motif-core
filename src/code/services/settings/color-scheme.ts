...
/*        Alert_Disabled,
    ...
    export namespace Item {
        ...
        const infosObject: InfosObject = {
            ...
            Environment_Test: {
                id: ItemId.Environment_Test,
                name: 'Environment_Test',
                display: 'Environment: Test',
                bkgdResolver: resolveBkgdColor_Environment_Test,
                foreResolver: resolveForeColor_Environment_Test,
            },
            Environment_NotStandard: {
                id: ItemId.Environment_NotStandard,
                name: 'Environment_NotStandard',
                display: 'Environment: Not standard',
                bkgdResolver: resolveBkgdColor_Environment_NotStandard,
                foreResolver: resolveForeColor_Environment_NotStandard,
            },
            Environment_Production_Offline: {
            ...
            Environment_Test_Offline: {
                id: ItemId.Environment_Test_Offline,
                name: 'Environment_Test_Offline',
                display: 'Environment: Test: Offline',
                bkgdResolver: resolveBkgdColor_Environment_Test_Offline,
                foreResolver: resolveForeColor_Environment_Test_Offline,
            },
            Environment_NotStandard_Offline: {
                id: ItemId.Environment_NotStandard_Offline,
                name: 'Environment_NotStandard_Offline',
                display: 'Environment: Not standard: Offline',
                bkgdResolver: resolveBkgdColor_Environment_NotStandard_Offline,
                foreResolver: resolveForeColor_Environment_NotStandard_Offline,
            },
            Environment_StartFinal: {
...
/*            OrderPad_Side_Buy: {
    ...
    function resolveBkgdColor_Environment_Test(items: Item[]) {
        const itemColor = items[ItemId.Environment_Test].bkgd;
        return (itemColor === schemeInheritColor) ? FallbackEnvironmentDemoBkgdColor : itemColor;
    }
    function resolveForeColor_Environment_Test(items: Item[]) {
        const itemColor = items[ItemId.Environment_Test].fore;
        return (itemColor === schemeInheritColor) ? resolveForeColor_Panel(items) : itemColor;
    }
    function resolveBkgdColor_Environment_NotStandard(items: Item[]) {
        const itemColor = items[ItemId.Environment_NotStandard].bkgd;
        return (itemColor === schemeInheritColor) ? FallbackEnvironmentDemoBkgdColor : itemColor;
    }
    function resolveForeColor_Environment_NotStandard(items: Item[]) {
        const itemColor = items[ItemId.Environment_NotStandard].fore;
        return (itemColor === schemeInheritColor) ? resolveForeColor_Panel(items) : itemColor;
    }
    ...
    function resolveBkgdColor_Environment_NotStandard_Offline(items: Item[]) {
        const itemColor = items[ItemId.Environment_NotStandard_Offline].bkgd;
        return (itemColor === schemeInheritColor) ? resolveBkgdColor_Environment_NotStandard(items) : itemColor;
    }
    function resolveForeColor_Environment_NotStandard_Offline(items: Item[]) {
        const itemColor = items[ItemId.Environment_NotStandard_Offline].fore;
        return (itemColor === schemeInheritColor) ? resolveForeColor_Environment_NotStandard(items) : itemColor;
    }
    function resolveBkgdColor_Environment_Test_Offline(items: Item[]) {
        const itemColor = items[ItemId.Environment_Test_Offline].bkgd;
        return (itemColor === schemeInheritColor) ? resolveBkgdColor_Environment_Test(items) : itemColor;
    }
    function resolveForeColor_Environment_Test_Offline(items: Item[]) {
        const itemColor = items[ItemId.Environment_Test_Offline].fore;
        return (itemColor === schemeInheritColor) ? resolveForeColor_Environment_Test(items) : itemColor;
    }
